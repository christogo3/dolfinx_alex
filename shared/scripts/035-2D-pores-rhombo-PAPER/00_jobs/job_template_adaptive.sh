...
#SBATCH -e /work/scratch/as12vapa/035-2D-pores-rhombo/{FOLDER_NAME}/%x.err.%j
#SBATCH -o /work/scratch/as12vapa/035-2D-pores-rhombo/{FOLDER_NAME}/%x.out.%j
...
working_directory="$HPC_SCRATCH/035-2D-pores-rhombo/$working_folder_name"
