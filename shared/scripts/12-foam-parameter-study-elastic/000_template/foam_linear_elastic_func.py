...
def run_simulation(scal,eps_mac_param, comm: MPI.Intercomm):
    ...
    # elastic constants
    lam = dlfx.fem.Constant(domain, 100.0)
    ...
    eps_mac = dlfx.fem.Constant(domain, eps_mac_param * scal)
    ...
    def after_timestep_success(t,dt,iters):
        ...
        # if rank == 0:
        sig_vm_crit = 0.3
        simulation_result[0] = pp.percentage_of_volume_above(domain,sig_vm,sig_vm_crit,comm,ufl.dx)
