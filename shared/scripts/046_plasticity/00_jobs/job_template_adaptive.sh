...
#SBATCH -e /work/scratch/as12vapa/046_plasticity/{FOLDER_NAME}/%x.err.%j
#SBATCH -o /work/scratch/as12vapa/046_plasticity/{FOLDER_NAME}/%x.out.%j
...
working_directory="$HPC_SCRATCH/046_plasticity/$working_folder_name"
