...
data_directory_plasticitys = os.path.join(script_path,'.','results','J-from-elastic')

simulation_data_folder_plasticitys = find_simulation_by_wsteg(data_directory_plasticitys,wsteg_value_in=1.0)
