...
phaseFieldProblem = pf.StaticPhaseFieldProblem2D_incremental_plasticity(degradationFunction=pf.degrad_cubic,
                                                   psisurf=pf.psisurf_from_function,dx=dx, sig_y=sig_y.value, hard=hard.value,alpha_n=alpha_n,e_p_n=ufl.as_matrix([[e_p_11_n, e_p_12_n], [e_p_12_n, e_p_22_n]]),Id=Id)
