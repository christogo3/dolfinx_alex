...
folder_path = os.path.join(script_path,"resources","Biegebalken_5F")
...
phaseFieldProblem = pf.StaticPhaseFieldProblem2D_split(degradationFunction=pf.degrad_quadratic,
