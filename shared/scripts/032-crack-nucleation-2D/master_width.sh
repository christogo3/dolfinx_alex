...
WIDTH_VALUES=(6.0 7.0 8.0 10.0 11.0 12.0)          # Example: domain widths larger that in case of circular hole because punch through occurs earlier
#WIDTH_VALUES=(6.0 7.0 11.0 12.0) 
