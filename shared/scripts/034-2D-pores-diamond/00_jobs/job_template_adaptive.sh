...
#SBATCH -e /work/scratch/as12vapa/034-2D-pores-diamond/{FOLDER_NAME}/%x.err.%j
#SBATCH -o /work/scratch/as12vapa/034-2D-pores-diamond/{FOLDER_NAME}/%x.out.%j
...
working_directory="$HPC_SCRATCH/034-2D-pores-diamond/$working_folder_name"
