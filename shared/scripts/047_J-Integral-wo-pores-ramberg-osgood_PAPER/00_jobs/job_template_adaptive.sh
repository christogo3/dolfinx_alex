...
#SBATCH -e /work/scratch/as12vapa/047_J-Integral-wo-pores-ramberg-osgood/{FOLDER_NAME}/%x.err.%j
#SBATCH -o /work/scratch/as12vapa/047_J-Integral-wo-pores-ramberg-osgood/{FOLDER_NAME}/%x.out.%j
...
working_directory="$HPC_SCRATCH/047_J-Integral-wo-pores-ramberg-osgood/$working_folder_name"
