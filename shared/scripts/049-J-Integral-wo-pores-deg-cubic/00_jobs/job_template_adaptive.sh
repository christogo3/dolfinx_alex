...
#SBATCH -e /work/scratch/as12vapa/049-J-Integral-wo-pores-deg-cubic/{FOLDER_NAME}/%x.err.%j
#SBATCH -o /work/scratch/as12vapa/049-J-Integral-wo-pores-deg-cubic/{FOLDER_NAME}/%x.out.%j
...
working_directory="$HPC_SCRATCH/049-J-Integral-wo-pores-deg-cubic/$working_folder_name"
