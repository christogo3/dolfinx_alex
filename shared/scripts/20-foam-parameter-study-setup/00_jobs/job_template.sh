...
#SBATCH -n 64
#SBATCH -e /work/scratch/as12vapa/20-foam-parameter-study-setup/{FOLDER_NAME}/%x.err.%j
#SBATCH -o /work/scratch/as12vapa/20-foam-parameter-study-setup/{FOLDER_NAME}/%x.out.%j
...
working_directory="$HPC_SCRATCH/20-foam-parameter-study-setup/$working_folder_name"
