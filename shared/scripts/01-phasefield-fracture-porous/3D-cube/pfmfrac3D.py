...
epsilon = dlfx.fem.Constant(domain, 0.2)
...
bctop_z = dlfx.fem.dirichletbc(0.0, topdofs_x, W.sub(0).sub(2))
# bctop_y =  fem.dirichletbc(utop, topdofs_y, W.sub(0).sub(1))
bcbottom_x = dlfx.fem.dirichletbc(0.0, bottomdofs_x, W.sub(0).sub(0))
bcbottom_z = dlfx.fem.dirichletbc(0.0, bottomdofs_x, W.sub(0).sub(2))
