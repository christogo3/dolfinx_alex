...
while t < Tend:
    ...
    pot = (degrad(s)*psiel(u+u_mac)+psisurf(s))*ufl.dx # decomposition in fluctuating and macro doesnt work here because nonlinear also?
    ...
    if not(restart_solution):
        ...
        xdmfout.write_function(u_mac,t)
        xdmfout.close()
