...
bcs = bc.get_total_linear_displacement_boundary_condition_at_quader(domain, comm, W,0,eps_mac)
bcs.append(bccrack)
...
def after_timestep_success(t,dt,iters):
    pp.write_phasefield_mixed_solution(outputfile_xdmf_path, w, t, comm)
