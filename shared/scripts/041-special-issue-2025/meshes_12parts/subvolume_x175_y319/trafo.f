...
c     x            0.d0 , 0.d0 , 0.d0 , 0.d0, 0.d0 , 4.63d-1 /
      cmat(1,1) = 1.133791d+03
      cmat(1,2) = 3.069462d+02
      cmat(1,3) = 4.394563d+02
      cmat(1,4) = 9.222635d+00
      cmat(1,5) = 7.241003d+01
      cmat(1,6) = 1.153806d+02
      cmat(2,1) = cmat(1,2)
      cmat(2,2) = 4.253339d+02
      cmat(2,3) = 6.305361d+02
      cmat(2,4) = -3.704386d+02
      cmat(2,5) = 1.243126d+03
      cmat(2,6) = 8.121037d+02
      cmat(3,1) = cmat(1,3)
      cmat(3,2) = cmat(2,3)
      cmat(3,3) = 1.046264d+03
      cmat(3,4) = 2.851152d+01
      cmat(3,5) = 1.172104d+03
      cmat(3,6) = 9.146239d+02
      cmat(4,1) = 1.992377d+03
      cmat(4,2) = -3.704386d+02
      cmat(4,3) = cmat(3,4)
      cmat(4,4) = 1.582507d+01
      cmat(4,5) = 1.121269d+03
      cmat(4,6) = 9.025646d+02
      cmat(5,1) = cmat(1,5)
      cmat(5,2) = cmat(2,5)
      cmat(5,3) = cmat(3,5)
      cmat(5,4) = cmat(4,5)
      cmat(5,5) = 1.091705d+03
      cmat(5,6) = 8.792774d+02
      cmat(6,1) = cmat(1,6)
      cmat(6,2) = cmat(2,6)
      cmat(6,3) = cmat(3,6)
      cmat(6,4) = cmat(4,6)
      cmat(6,5) = cmat(5,6)
      cmat(6,6) = 7.154332d+02
