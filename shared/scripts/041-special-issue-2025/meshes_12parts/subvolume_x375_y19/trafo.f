...
c     x            0.d0 , 0.d0 , 0.d0 , 0.d0, 0.d0 , 4.63d-1 /
      cmat(1,1) = 4.846854d+03
      cmat(1,2) = 1.668754d+03
      cmat(1,3) = 1.584793d+03
      cmat(1,4) = -2.316985d+02
      cmat(1,5) = 1.257362d+02
      cmat(1,6) = 4.432653d+01
      cmat(2,1) = cmat(1,2)
      cmat(2,2) = 1.650875d+04
      cmat(2,3) = 4.474253d+03
      cmat(2,4) = 3.625542d+03
      cmat(2,5) = 1.318026d+03
      cmat(2,6) = -6.995632d+03
      cmat(3,1) = cmat(1,3)
      cmat(3,2) = cmat(2,3)
      cmat(3,3) = 5.655382d+03
      cmat(3,4) = 4.916619d+02
      cmat(3,5) = -1.342258d+03
      cmat(3,6) = 1.991757d+02
      cmat(4,1) = 2.870466d+03
      cmat(4,2) = 3.625542d+03
      cmat(4,3) = cmat(3,4)
      cmat(4,4) = 2.903607d+03
      cmat(4,5) = -3.589374d+03
      cmat(4,6) = -2.464785d+02
      cmat(5,1) = cmat(1,5)
      cmat(5,2) = cmat(2,5)
      cmat(5,3) = cmat(3,5)
      cmat(5,4) = cmat(4,5)
      cmat(5,5) = 1.203829d+03
      cmat(5,6) = 4.397801d+02
      cmat(6,1) = cmat(1,6)
      cmat(6,2) = cmat(2,6)
      cmat(6,3) = cmat(3,6)
      cmat(6,4) = cmat(4,6)
      cmat(6,5) = cmat(5,6)
      cmat(6,6) = 2.882337d+03
