...
c     x            0.d0 , 0.d0 , 0.d0 , 0.d0, 0.d0 , 4.63d-1 /
      cmat(1,1) = 1.797179d+03
      cmat(1,2) = 3.531613d+02
      cmat(1,3) = 4.801446d+02
      cmat(1,4) = -3.215473d+01
      cmat(1,5) = -1.133384d+02
      cmat(1,6) = 3.215806d+01
      cmat(2,1) = cmat(1,2)
      cmat(2,2) = 1.346249d+03
      cmat(2,3) = 9.969384d+02
      cmat(2,4) = -6.907184d+02
      cmat(2,5) = 2.343128d+03
      cmat(2,6) = -3.774927d+01
      cmat(3,1) = cmat(1,3)
      cmat(3,2) = cmat(2,3)
      cmat(3,3) = 1.075822d+03
      cmat(3,4) = -4.954494d+01
      cmat(3,5) = 2.314263d+03
      cmat(3,6) = -3.724406d+01
      cmat(4,1) = 2.862308d+03
      cmat(4,2) = -6.907184d+02
      cmat(4,3) = cmat(3,4)
      cmat(4,4) = 3.620931d+00
      cmat(4,5) = 2.219541d+03
      cmat(4,6) = -2.568185d+01
      cmat(5,1) = cmat(1,5)
      cmat(5,2) = cmat(2,5)
      cmat(5,3) = cmat(3,5)
      cmat(5,4) = cmat(4,5)
      cmat(5,5) = 2.127460d+03
      cmat(5,6) = 8.518610d+00
      cmat(6,1) = cmat(1,6)
      cmat(6,2) = cmat(2,6)
      cmat(6,3) = cmat(3,6)
      cmat(6,4) = cmat(4,6)
      cmat(6,5) = cmat(5,6)
      cmat(6,6) = 1.920877d+02
