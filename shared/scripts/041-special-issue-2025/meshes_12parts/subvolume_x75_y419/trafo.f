...
c     x            0.d0 , 0.d0 , 0.d0 , 0.d0, 0.d0 , 4.63d-1 /
      cmat(1,1) = 4.612875d+03
      cmat(1,2) = 1.857609d+03
      cmat(1,3) = 1.262728d+03
      cmat(1,4) = -1.311993d+01
      cmat(1,5) = 7.086035d+02
      cmat(1,6) = -2.532874d+01
      cmat(2,1) = cmat(1,2)
      cmat(2,2) = 2.981966d+02
      cmat(2,3) = -8.294754d+02
      cmat(2,4) = 2.976741d+03
      cmat(2,5) = -1.272253d+04
      cmat(2,6) = 3.449621d+02
      cmat(3,1) = cmat(1,3)
      cmat(3,2) = cmat(2,3)
      cmat(3,3) = 7.861788d+03
      cmat(3,4) = -5.442270d+02
      cmat(3,5) = -1.224538d+04
      cmat(3,6) = 5.139380d+02
      cmat(4,1) = 4.781264d+03
      cmat(4,2) = 2.976741d+03
      cmat(4,3) = cmat(3,4)
      cmat(4,4) = 2.053670d+03
      cmat(4,5) = -1.262283d+04
      cmat(4,6) = 4.812103d+02
      cmat(5,1) = cmat(1,5)
      cmat(5,2) = cmat(2,5)
      cmat(5,3) = cmat(3,5)
      cmat(5,4) = cmat(4,5)
      cmat(5,5) = -9.722079d+03
      cmat(5,6) = 4.334636d+02
      cmat(6,1) = cmat(1,6)
      cmat(6,2) = cmat(2,6)
      cmat(6,3) = cmat(3,6)
      cmat(6,4) = cmat(4,6)
      cmat(6,5) = cmat(5,6)
      cmat(6,6) = 9.857800d+02
