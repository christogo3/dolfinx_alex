...
c     x            0.d0 , 0.d0 , 0.d0 , 0.d0, 0.d0 , 4.63d-1 /
      cmat(1,1) = 1.426786d+03
      cmat(1,2) = 3.587474d+02
      cmat(1,3) = 4.041907d+02
      cmat(1,4) = -1.026719d+01
      cmat(1,5) = 2.651956d+01
      cmat(1,6) = 7.157634d+01
      cmat(2,1) = cmat(1,2)
      cmat(2,2) = 3.607912d+01
      cmat(2,3) = 5.900109d+01
      cmat(2,4) = -1.209324d+02
      cmat(2,5) = 1.389528d+02
      cmat(2,6) = 4.092502d+02
      cmat(3,1) = cmat(1,3)
      cmat(3,2) = cmat(2,3)
      cmat(3,3) = 4.170933d+02
      cmat(3,4) = -1.352484d+02
      cmat(3,5) = 2.808049d+02
      cmat(3,6) = 2.171654d+02
      cmat(4,1) = -2.729798d+02
      cmat(4,2) = -1.209324d+02
      cmat(4,3) = cmat(3,4)
      cmat(4,4) = 6.507736d+01
      cmat(4,5) = 2.573064d+02
      cmat(4,6) = 2.526887d+02
      cmat(5,1) = cmat(1,5)
      cmat(5,2) = cmat(2,5)
      cmat(5,3) = cmat(3,5)
      cmat(5,4) = cmat(4,5)
      cmat(5,5) = 4.579492d+02
      cmat(5,6) = 1.357711d+02
      cmat(6,1) = cmat(1,6)
      cmat(6,2) = cmat(2,6)
      cmat(6,3) = cmat(3,6)
      cmat(6,4) = cmat(4,6)
      cmat(6,5) = cmat(5,6)
      cmat(6,6) = 4.289842d+02
