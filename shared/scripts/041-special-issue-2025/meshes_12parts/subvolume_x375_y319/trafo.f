...
c     x            0.d0 , 0.d0 , 0.d0 , 0.d0, 0.d0 , 4.63d-1 /
      cmat(1,1) = 2.133229d+03
      cmat(1,2) = 8.221723d+02
      cmat(1,3) = 8.099256d+02
      cmat(1,4) = -5.618927d+01
      cmat(1,5) = -3.029443d+01
      cmat(1,6) = 4.431033d+01
      cmat(2,1) = cmat(1,2)
      cmat(2,2) = 7.441850d+03
      cmat(2,3) = 1.300842d+03
      cmat(2,4) = 2.155570d+03
      cmat(2,5) = -2.305218d+03
      cmat(2,6) = -4.590723d+02
      cmat(3,1) = cmat(1,3)
      cmat(3,2) = cmat(2,3)
      cmat(3,3) = 2.900421d+03
      cmat(3,4) = 4.191574d+02
      cmat(3,5) = -1.773570d+03
      cmat(3,6) = -2.207152d+03
      cmat(4,1) = -9.397959d+02
      cmat(4,2) = 2.155570d+03
      cmat(4,3) = cmat(3,4)
      cmat(4,4) = 1.630919d+03
      cmat(4,5) = -1.347178d+03
      cmat(4,6) = -2.074392d+03
      cmat(5,1) = cmat(1,5)
      cmat(5,2) = cmat(2,5)
      cmat(5,3) = cmat(3,5)
      cmat(5,4) = cmat(4,5)
      cmat(5,5) = -6.854050d+02
      cmat(5,6) = -1.943435d+03
      cmat(6,1) = cmat(1,6)
      cmat(6,2) = cmat(2,6)
      cmat(6,3) = cmat(3,6)
      cmat(6,4) = cmat(4,6)
      cmat(6,5) = cmat(5,6)
      cmat(6,6) = 2.698456d+02
