...
c     x            0.d0 , 0.d0 , 0.d0 , 0.d0, 0.d0 , 4.63d-1 /
      cmat(1,1) = 1.767612d+03
      cmat(1,2) = 6.845048d+02
      cmat(1,3) = 7.041598d+02
      cmat(1,4) = 1.208677d+01
      cmat(1,5) = -2.745369d+01
      cmat(1,6) = -4.884467d+00
      cmat(2,1) = cmat(1,2)
      cmat(2,2) = -1.554843d+03
      cmat(2,3) = -1.695245d+03
      cmat(2,4) = -8.228446d+02
      cmat(2,5) = 1.481647d+02
      cmat(2,6) = 3.174128d+03
      cmat(3,1) = cmat(1,3)
      cmat(3,2) = cmat(2,3)
      cmat(3,3) = 7.308236d+01
      cmat(3,4) = -2.555678d+02
      cmat(3,5) = 4.909026d+02
      cmat(3,6) = 3.788890d+02
      cmat(4,1) = -5.830795d+03
      cmat(4,2) = -8.228446d+02
      cmat(4,3) = cmat(3,4)
      cmat(4,4) = -7.205387d+01
      cmat(4,5) = 1.502860d+03
      cmat(4,6) = 5.573218d+02
      cmat(5,1) = cmat(1,5)
      cmat(5,2) = cmat(2,5)
      cmat(5,3) = cmat(3,5)
      cmat(5,4) = cmat(4,5)
      cmat(5,5) = 2.321011d+03
      cmat(5,6) = 3.885040d+02
      cmat(6,1) = cmat(1,6)
      cmat(6,2) = cmat(2,6)
      cmat(6,3) = cmat(3,6)
      cmat(6,4) = cmat(4,6)
      cmat(6,5) = cmat(5,6)
      cmat(6,6) = 2.377906d+03
