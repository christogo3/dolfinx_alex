...
c     x            0.d0 , 0.d0 , 0.d0 , 0.d0, 0.d0 , 4.63d-1 /
      cmat(1,1) = 1.419822d+03
      cmat(1,2) = 5.485710d+02
      cmat(1,3) = 6.052054d+02
      cmat(1,4) = 4.988776d+00
      cmat(1,5) = 2.271428d+01
      cmat(1,6) = -3.610236d+00
      cmat(2,1) = cmat(1,2)
      cmat(2,2) = -3.938394d+02
      cmat(2,3) = 4.507464d+02
      cmat(2,4) = -9.223194d+02
      cmat(2,5) = 1.598729d+03
      cmat(2,6) = 1.078199d+03
      cmat(3,1) = cmat(1,3)
      cmat(3,2) = cmat(2,3)
      cmat(3,3) = 9.841052d+02
      cmat(3,4) = 2.801033d+01
      cmat(3,5) = 1.631746d+03
      cmat(3,6) = 7.673086d+02
      cmat(4,1) = -9.880000d+02
      cmat(4,2) = -9.223194d+02
      cmat(4,3) = cmat(3,4)
      cmat(4,4) = 2.294331d+02
      cmat(4,5) = 1.695570d+03
      cmat(4,6) = 7.353436d+02
      cmat(5,1) = cmat(1,5)
      cmat(5,2) = cmat(2,5)
      cmat(5,3) = cmat(3,5)
      cmat(5,4) = cmat(4,5)
      cmat(5,5) = 1.984105d+03
      cmat(5,6) = 6.543224d+02
      cmat(6,1) = cmat(1,6)
      cmat(6,2) = cmat(2,6)
      cmat(6,3) = cmat(3,6)
      cmat(6,4) = cmat(4,6)
      cmat(6,5) = cmat(5,6)
      cmat(6,6) = 1.027317d+03
