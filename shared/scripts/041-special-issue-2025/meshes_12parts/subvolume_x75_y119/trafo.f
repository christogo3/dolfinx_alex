...
c     x            0.d0 , 0.d0 , 0.d0 , 0.d0, 0.d0 , 4.63d-1 /
      cmat(1,1) = 2.281900d+03
      cmat(1,2) = 8.799231d+02
      cmat(1,3) = 8.610332d+02
      cmat(1,4) = 3.352259d+01
      cmat(1,5) = 6.973608d+01
      cmat(1,6) = 4.049285d+01
      cmat(2,1) = cmat(1,2)
      cmat(2,2) = 1.305194d+03
      cmat(2,3) = 1.197010d+03
      cmat(2,4) = 2.067184d+02
      cmat(2,5) = -1.591138d+02
      cmat(2,6) = 2.058595d+02
      cmat(3,1) = cmat(1,3)
      cmat(3,2) = cmat(2,3)
      cmat(3,3) = 3.275065d+03
      cmat(3,4) = -4.881533d+02
      cmat(3,5) = -7.255766d+02
      cmat(3,6) = 6.729428d+02
      cmat(4,1) = 2.133563d+03
      cmat(4,2) = 2.067184d+02
      cmat(4,3) = cmat(3,4)
      cmat(4,4) = 4.226369d+02
      cmat(4,5) = -4.520420d+02
      cmat(4,6) = 4.435974d+02
      cmat(5,1) = cmat(1,5)
      cmat(5,2) = cmat(2,5)
      cmat(5,3) = cmat(3,5)
      cmat(5,4) = cmat(4,5)
      cmat(5,5) = -2.929179d+01
      cmat(5,6) = 4.169700d+02
      cmat(6,1) = cmat(1,6)
      cmat(6,2) = cmat(2,6)
      cmat(6,3) = cmat(3,6)
      cmat(6,4) = cmat(4,6)
      cmat(6,5) = cmat(5,6)
      cmat(6,6) = 6.597954d+02
