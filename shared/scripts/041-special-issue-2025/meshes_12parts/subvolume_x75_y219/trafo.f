...
c     x            0.d0 , 0.d0 , 0.d0 , 0.d0, 0.d0 , 4.63d-1 /
      cmat(1,1) = 2.027554d+03
      cmat(1,2) = 8.152138d+02
      cmat(1,3) = 7.859161d+02
      cmat(1,4) = -5.397768d+01
      cmat(1,5) = -3.341370d+01
      cmat(1,6) = -2.400893d+01
      cmat(2,1) = cmat(1,2)
      cmat(2,2) = 1.367614d+03
      cmat(2,3) = -1.024973d+03
      cmat(2,4) = 2.290440d+02
      cmat(2,5) = -3.160135d+02
      cmat(2,6) = 3.570090d+02
      cmat(3,1) = cmat(1,3)
      cmat(3,2) = cmat(2,3)
      cmat(3,3) = 3.739405d+02
      cmat(3,4) = 3.318320d+02
      cmat(3,5) = 3.932069d+02
      cmat(3,6) = -6.159663d+02
      cmat(4,1) = -5.426214d+03
      cmat(4,2) = 2.290440d+02
      cmat(4,3) = cmat(3,4)
      cmat(4,4) = 1.029729d+03
      cmat(4,5) = 2.404577d+02
      cmat(4,6) = -1.913951d+02
      cmat(5,1) = cmat(1,5)
      cmat(5,2) = cmat(2,5)
      cmat(5,3) = cmat(3,5)
      cmat(5,4) = cmat(4,5)
      cmat(5,5) = 1.531649d+03
      cmat(5,6) = -5.341733d+02
      cmat(6,1) = cmat(1,6)
      cmat(6,2) = cmat(2,6)
      cmat(6,3) = cmat(3,6)
      cmat(6,4) = cmat(4,6)
      cmat(6,5) = cmat(5,6)
      cmat(6,6) = 1.331062d+03
