...
c     x            0.d0 , 0.d0 , 0.d0 , 0.d0, 0.d0 , 4.63d-1 /
      cmat(1,1) = 3.745462d+02
      cmat(1,2) = 1.459711d+02
      cmat(1,3) = 1.471886d+02
      cmat(1,4) = -1.609047d+00
      cmat(1,5) = -9.817091d+01
      cmat(1,6) = -4.360836d+01
      cmat(2,1) = cmat(1,2)
      cmat(2,2) = 5.792079d+02
      cmat(2,3) = 9.520960d+02
      cmat(2,4) = -9.452969d+02
      cmat(2,5) = 3.422141d+01
      cmat(2,6) = -1.888308d+03
      cmat(3,1) = cmat(1,3)
      cmat(3,2) = cmat(2,3)
      cmat(3,3) = 1.078125d+03
      cmat(3,4) = -5.134889d+01
      cmat(3,5) = -9.697166d+01
      cmat(3,6) = -1.230468d+02
      cmat(4,1) = 2.544647d+03
      cmat(4,2) = -9.452969d+02
      cmat(4,3) = cmat(3,4)
      cmat(4,4) = -1.937205d+02
      cmat(4,5) = -2.769255d+02
      cmat(4,6) = -8.290194d+01
      cmat(5,1) = cmat(1,5)
      cmat(5,2) = cmat(2,5)
      cmat(5,3) = cmat(3,5)
      cmat(5,4) = cmat(4,5)
      cmat(5,5) = -8.754318d+01
      cmat(5,6) = 2.640489d+01
      cmat(6,1) = cmat(1,6)
      cmat(6,2) = cmat(2,6)
      cmat(6,3) = cmat(3,6)
      cmat(6,4) = cmat(4,6)
      cmat(6,5) = cmat(5,6)
      cmat(6,6) = -8.639952d+02
