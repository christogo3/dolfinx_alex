...
c     x            0.d0 , 0.d0 , 0.d0 , 0.d0, 0.d0 , 4.63d-1 /
      cmat(1,1) = 4.611757d+03
      cmat(1,2) = 1.629341d+03
      cmat(1,3) = 1.559011d+03
      cmat(1,4) = -1.851193d+02
      cmat(1,5) = 4.217393d+01
      cmat(1,6) = 1.390038d+02
      cmat(2,1) = cmat(1,2)
      cmat(2,2) = 1.512761d+04
      cmat(2,3) = 4.629924d+03
      cmat(2,4) = -5.255799d+02
      cmat(2,5) = 2.598275d+02
      cmat(2,6) = 5.007545d+02
      cmat(3,1) = cmat(1,3)
      cmat(3,2) = cmat(2,3)
      cmat(3,3) = 5.094326d+03
      cmat(3,4) = 1.468269d+03
      cmat(3,5) = -1.840798d+02
      cmat(3,6) = -3.343567d+01
      cmat(4,1) = 2.199827d+03
      cmat(4,2) = -5.255799d+02
      cmat(4,3) = cmat(3,4)
      cmat(4,4) = 2.944210d+03
      cmat(4,5) = -1.845458d+02
      cmat(4,6) = 3.637918d+01
      cmat(5,1) = cmat(1,5)
      cmat(5,2) = cmat(2,5)
      cmat(5,3) = cmat(3,5)
      cmat(5,4) = cmat(4,5)
      cmat(5,5) = 1.351294d+03
      cmat(5,6) = 8.174149d+02
      cmat(6,1) = cmat(1,6)
      cmat(6,2) = cmat(2,6)
      cmat(6,3) = cmat(3,6)
      cmat(6,4) = cmat(4,6)
      cmat(6,5) = cmat(5,6)
      cmat(6,6) = 3.330189d+03
