...
c     x            0.d0 , 0.d0 , 0.d0 , 0.d0, 0.d0 , 4.63d-1 /
      cmat(1,1) = 2.258398d+03
      cmat(1,2) = 7.916250d+02
      cmat(1,3) = 9.254778d+02
      cmat(1,4) = -5.543492d+00
      cmat(1,5) = -3.012235d+01
      cmat(1,6) = 4.085420d+01
      cmat(2,1) = cmat(1,2)
      cmat(2,2) = 7.535053d+03
      cmat(2,3) = 3.511122d+03
      cmat(2,4) = -2.215706d+02
      cmat(2,5) = 1.434277d+01
      cmat(2,6) = -1.683181d+03
      cmat(3,1) = cmat(1,3)
      cmat(3,2) = cmat(2,3)
      cmat(3,3) = 2.828905d+03
      cmat(3,4) = 8.751454d+02
      cmat(3,5) = -1.554226d+02
      cmat(3,6) = -1.231675d+03
      cmat(4,1) = 2.428133d+03
      cmat(4,2) = -2.215706d+02
      cmat(4,3) = cmat(3,4)
      cmat(4,4) = 1.813731d+03
      cmat(4,5) = -5.579370d+02
      cmat(4,6) = -1.406137d+03
      cmat(5,1) = cmat(1,5)
      cmat(5,2) = cmat(2,5)
      cmat(5,3) = cmat(3,5)
      cmat(5,4) = cmat(4,5)
      cmat(5,5) = 3.213291d+02
      cmat(5,6) = -8.822130d+02
      cmat(6,1) = cmat(1,6)
      cmat(6,2) = cmat(2,6)
      cmat(6,3) = cmat(3,6)
      cmat(6,4) = cmat(4,6)
      cmat(6,5) = cmat(5,6)
      cmat(6,6) = 4.370971d+02
