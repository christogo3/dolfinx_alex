...
c     x            0.d0 , 0.d0 , 0.d0 , 0.d0, 0.d0 , 4.63d-1 /
      cmat(1,1) = 1.350793d+03
      cmat(1,2) = 5.601307d+02
      cmat(1,3) = 5.067341d+02
      cmat(1,4) = 5.740653d+00
      cmat(1,5) = -3.053813d+02
      cmat(1,6) = -9.725398d+00
      cmat(2,1) = cmat(1,2)
      cmat(2,2) = 1.021538d+04
      cmat(2,3) = 2.046736d+03
      cmat(2,4) = -5.138005d+03
      cmat(2,5) = 4.725953d+03
      cmat(2,6) = -9.431954d+03
      cmat(3,1) = cmat(1,3)
      cmat(3,2) = cmat(2,3)
      cmat(3,3) = -4.596593d+02
      cmat(3,4) = 2.904208d+03
      cmat(3,5) = 5.439975d+03
      cmat(3,6) = -4.015563d+03
      cmat(4,1) = 1.160192d+04
      cmat(4,2) = -5.138005d+03
      cmat(4,3) = cmat(3,4)
      cmat(4,4) = 4.501876d+03
      cmat(4,5) = 4.416885d+03
      cmat(4,6) = -4.876815d+03
      cmat(5,1) = cmat(1,5)
      cmat(5,2) = cmat(2,5)
      cmat(5,3) = cmat(3,5)
      cmat(5,4) = cmat(4,5)
      cmat(5,5) = 4.593028d+03
      cmat(5,6) = -4.769056d+03
      cmat(6,1) = cmat(1,6)
      cmat(6,2) = cmat(2,6)
      cmat(6,3) = cmat(3,6)
      cmat(6,4) = cmat(4,6)
      cmat(6,5) = cmat(5,6)
      cmat(6,6) = -5.418118d+03
