...
c     x            0.d0 , 0.d0 , 0.d0 , 0.d0, 0.d0 , 4.63d-1 /
      cmat(1,1) = 2.582938d+03
      cmat(1,2) = 9.195327d+02
      cmat(1,3) = 8.747097d+02
      cmat(1,4) = 2.403554d+01
      cmat(1,5) = -9.538403d+01
      cmat(1,6) = 4.938633d+01
      cmat(2,1) = cmat(1,2)
      cmat(2,2) = 5.767323d+02
      cmat(2,3) = 7.819412d+02
      cmat(2,4) = 3.898572d+03
      cmat(2,5) = -1.767603d+03
      cmat(2,6) = 1.396421d+02
      cmat(3,1) = cmat(1,3)
      cmat(3,2) = cmat(2,3)
      cmat(3,3) = 5.174484d+03
      cmat(3,4) = -6.297994d-01
      cmat(3,5) = -1.881652d+03
      cmat(3,6) = 1.989262d+02
      cmat(4,1) = 2.203338d+03
      cmat(4,2) = 3.898572d+03
      cmat(4,3) = cmat(3,4)
      cmat(4,4) = 1.118992d+03
      cmat(4,5) = -1.760502d+03
      cmat(4,6) = 1.712617d+02
      cmat(5,1) = cmat(1,5)
      cmat(5,2) = cmat(2,5)
      cmat(5,3) = cmat(3,5)
      cmat(5,4) = cmat(4,5)
      cmat(5,5) = -6.410564d+02
      cmat(5,6) = 1.830832d+02
      cmat(6,1) = cmat(1,6)
      cmat(6,2) = cmat(2,6)
      cmat(6,3) = cmat(3,6)
      cmat(6,4) = cmat(4,6)
      cmat(6,5) = cmat(5,6)
      cmat(6,6) = 5.090213d+02
