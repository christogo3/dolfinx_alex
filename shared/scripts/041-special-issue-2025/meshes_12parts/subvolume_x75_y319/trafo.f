...
c     x            0.d0 , 0.d0 , 0.d0 , 0.d0, 0.d0 , 4.63d-1 /
      cmat(1,1) = 2.214843d+03
      cmat(1,2) = 9.330126d+02
      cmat(1,3) = 9.474849d+02
      cmat(1,4) = -2.636133d-02
      cmat(1,5) = 1.045225d+02
      cmat(1,6) = 5.672602d+01
      cmat(2,1) = cmat(1,2)
      cmat(2,2) = 4.167476d+03
      cmat(2,3) = 2.797234d+03
      cmat(2,4) = -7.576840d+01
      cmat(2,5) = 7.499369d+02
      cmat(2,6) = -5.875890d+02
      cmat(3,1) = cmat(1,3)
      cmat(3,2) = cmat(2,3)
      cmat(3,3) = 3.640049d+03
      cmat(3,4) = 2.842198d+01
      cmat(3,5) = 2.627925d+02
      cmat(3,6) = -2.026657d+02
      cmat(4,1) = 4.178332d+03
      cmat(4,2) = -7.576840d+01
      cmat(4,3) = cmat(3,4)
      cmat(4,4) = 6.569092d+02
      cmat(4,5) = 5.434229d+02
      cmat(4,6) = -4.949004d+02
      cmat(5,1) = cmat(1,5)
      cmat(5,2) = cmat(2,5)
      cmat(5,3) = cmat(3,5)
      cmat(5,4) = cmat(4,5)
      cmat(5,5) = 3.941528d+02
      cmat(5,6) = -1.597111d+02
      cmat(6,1) = cmat(1,6)
      cmat(6,2) = cmat(2,6)
      cmat(6,3) = cmat(3,6)
      cmat(6,4) = cmat(4,6)
      cmat(6,5) = cmat(5,6)
      cmat(6,6) = -4.083317d+02
