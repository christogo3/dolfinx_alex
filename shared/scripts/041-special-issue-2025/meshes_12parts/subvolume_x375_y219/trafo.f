...
c     x            0.d0 , 0.d0 , 0.d0 , 0.d0, 0.d0 , 4.63d-1 /
      cmat(1,1) = 1.922081d+03
      cmat(1,2) = 6.920795d+02
      cmat(1,3) = 7.288702d+02
      cmat(1,4) = -3.639481d+01
      cmat(1,5) = 8.980832d+01
      cmat(1,6) = 8.526109d+01
      cmat(2,1) = cmat(1,2)
      cmat(2,2) = 9.850946d+03
      cmat(2,3) = 2.656254d+03
      cmat(2,4) = 2.001696d+03
      cmat(2,5) = -1.083616d+03
      cmat(2,6) = -1.953360d+03
      cmat(3,1) = cmat(1,3)
      cmat(3,2) = cmat(2,3)
      cmat(3,3) = 3.331770d+03
      cmat(3,4) = 1.783902d+02
      cmat(3,5) = -1.327792d+03
      cmat(3,6) = -1.477230d+03
      cmat(4,1) = 2.721714d+03
      cmat(4,2) = 2.001696d+03
      cmat(4,3) = cmat(3,4)
      cmat(4,4) = 1.767776d+03
      cmat(4,5) = -1.423141d+03
      cmat(4,6) = -1.378423d+03
      cmat(5,1) = cmat(1,5)
      cmat(5,2) = cmat(2,5)
      cmat(5,3) = cmat(3,5)
      cmat(5,4) = cmat(4,5)
      cmat(5,5) = -8.595057d+02
      cmat(5,6) = -1.191689d+03
      cmat(6,1) = cmat(1,6)
      cmat(6,2) = cmat(2,6)
      cmat(6,3) = cmat(3,6)
      cmat(6,4) = cmat(4,6)
      cmat(6,5) = cmat(5,6)
      cmat(6,6) = 6.619821d+01
