...
c     x            0.d0 , 0.d0 , 0.d0 , 0.d0, 0.d0 , 4.63d-1 /
      cmat(1,1) = 2.099595d+03
      cmat(1,2) = 8.024046d+02
      cmat(1,3) = 8.007322d+02
      cmat(1,4) = 2.153319d+01
      cmat(1,5) = -6.826447d+01
      cmat(1,6) = -1.284932d+01
      cmat(2,1) = cmat(1,2)
      cmat(2,2) = -2.731901d+03
      cmat(2,3) = -2.092363d+03
      cmat(2,4) = 1.076909d+03
      cmat(2,5) = -3.840130d+02
      cmat(2,6) = 2.664481d+03
      cmat(3,1) = cmat(1,3)
      cmat(3,2) = cmat(2,3)
      cmat(3,3) = 1.094476d+03
      cmat(3,4) = -2.584502d+02
      cmat(3,5) = 3.619232d+02
      cmat(3,6) = 6.079366d+02
      cmat(4,1) = -5.922676d+03
      cmat(4,2) = 1.076909d+03
      cmat(4,3) = cmat(3,4)
      cmat(4,4) = 1.692561d+02
      cmat(4,5) = 8.953042d+02
      cmat(4,6) = 9.079829d+02
      cmat(5,1) = cmat(1,5)
      cmat(5,2) = cmat(2,5)
      cmat(5,3) = cmat(3,5)
      cmat(5,4) = cmat(4,5)
      cmat(5,5) = 1.409942d+03
      cmat(5,6) = 5.240013d+02
      cmat(6,1) = cmat(1,6)
      cmat(6,2) = cmat(2,6)
      cmat(6,3) = cmat(3,6)
      cmat(6,4) = cmat(4,6)
      cmat(6,5) = cmat(5,6)
      cmat(6,6) = 1.705107d+03
