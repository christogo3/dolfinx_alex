...
c     x            0.d0 , 0.d0 , 0.d0 , 0.d0, 0.d0 , 4.63d-1 /
      cmat(1,1) = 2.332059d+03
      cmat(1,2) = 7.094141d+02
      cmat(1,3) = 7.729071d+02
      cmat(1,4) = 8.281153d+00
      cmat(1,5) = 3.123392d+01
      cmat(1,6) = -1.048339d+02
      cmat(2,1) = cmat(1,2)
      cmat(2,2) = -4.521618d+03
      cmat(2,3) = -1.148106d+03
      cmat(2,4) = -5.647685d+02
      cmat(2,5) = 3.513396d+02
      cmat(2,6) = -3.435111d+02
      cmat(3,1) = cmat(1,3)
      cmat(3,2) = cmat(2,3)
      cmat(3,3) = 1.454912d+03
      cmat(3,4) = -3.341677d+02
      cmat(3,5) = -4.478746d+01
      cmat(3,6) = -1.066964d+01
      cmat(4,1) = 1.007988d+02
      cmat(4,2) = -5.647685d+02
      cmat(4,3) = cmat(3,4)
      cmat(4,4) = -7.712087d+02
      cmat(4,5) = -3.627636d+02
      cmat(4,6) = 3.687463d+01
      cmat(5,1) = cmat(1,5)
      cmat(5,2) = cmat(2,5)
      cmat(5,3) = cmat(3,5)
      cmat(5,4) = cmat(4,5)
      cmat(5,5) = 5.869916d+02
      cmat(5,6) = -1.602394d+02
      cmat(6,1) = cmat(1,6)
      cmat(6,2) = cmat(2,6)
      cmat(6,3) = cmat(3,6)
      cmat(6,4) = cmat(4,6)
      cmat(6,5) = cmat(5,6)
      cmat(6,6) = -8.640999d+02
