...
c     x            0.d0 , 0.d0 , 0.d0 , 0.d0, 0.d0 , 4.63d-1 /
      cmat(1,1) = 1.563950d+03
      cmat(1,2) = 5.901519d+02
      cmat(1,3) = 6.406983d+02
      cmat(1,4) = -1.433871d+01
      cmat(1,5) = 7.177332d-01
      cmat(1,6) = 5.716988d+01
      cmat(2,1) = cmat(1,2)
      cmat(2,2) = 6.775947d+03
      cmat(2,3) = 2.452568d+03
      cmat(2,4) = -5.447876d+02
      cmat(2,5) = 2.266290d+02
      cmat(2,6) = -7.180251d+02
      cmat(3,1) = cmat(1,3)
      cmat(3,2) = cmat(2,3)
      cmat(3,3) = 1.597898d+03
      cmat(3,4) = 1.937144d+02
      cmat(3,5) = 9.205823d+01
      cmat(3,6) = -3.938000d+02
      cmat(4,1) = 1.907303d+02
      cmat(4,2) = -5.447876d+02
      cmat(4,3) = cmat(3,4)
      cmat(4,4) = 1.489120d+03
      cmat(4,5) = -2.253933d+02
      cmat(4,6) = -3.814071d+02
      cmat(5,1) = cmat(1,5)
      cmat(5,2) = cmat(2,5)
      cmat(5,3) = cmat(3,5)
      cmat(5,4) = cmat(4,5)
      cmat(5,5) = 5.633057d+02
      cmat(5,6) = -3.413615d+02
      cmat(6,1) = cmat(1,6)
      cmat(6,2) = cmat(2,6)
      cmat(6,3) = cmat(3,6)
      cmat(6,4) = cmat(4,6)
      cmat(6,5) = cmat(5,6)
      cmat(6,6) = 7.168286d+02
