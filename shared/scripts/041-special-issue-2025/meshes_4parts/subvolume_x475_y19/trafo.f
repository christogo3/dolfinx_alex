...
c     x            0.d0 , 0.d0 , 0.d0 , 0.d0, 0.d0 , 4.63d-1 /
      cmat(1,1) = 2.192907d+03
      cmat(1,2) = 9.222209d+02
      cmat(1,3) = 9.850796d+02
      cmat(1,4) = 3.627936d+01
      cmat(1,5) = 3.570133d+01
      cmat(1,6) = 1.773996d+01
      cmat(2,1) = cmat(1,2)
      cmat(2,2) = 4.333206d+03
      cmat(2,3) = 1.292039d+03
      cmat(2,4) = -5.530978d+02
      cmat(2,5) = 2.739065d+02
      cmat(2,6) = 4.185456d+03
      cmat(3,1) = cmat(1,3)
      cmat(3,2) = cmat(2,3)
      cmat(3,3) = 1.201925d+03
      cmat(3,4) = 3.843894d+01
      cmat(3,5) = 2.758256d+02
      cmat(3,6) = 3.054163d+01
      cmat(4,1) = -1.506127d+03
      cmat(4,2) = -5.530978d+02
      cmat(4,3) = cmat(3,4)
      cmat(4,4) = 9.364177d+02
      cmat(4,5) = 2.017566d+03
      cmat(4,6) = 2.797333d+02
      cmat(5,1) = cmat(1,5)
      cmat(5,2) = cmat(2,5)
      cmat(5,3) = cmat(3,5)
      cmat(5,4) = cmat(4,5)
      cmat(5,5) = 7.121522d+02
      cmat(5,6) = 9.014718d+00
      cmat(6,1) = cmat(1,6)
      cmat(6,2) = cmat(2,6)
      cmat(6,3) = cmat(3,6)
      cmat(6,4) = cmat(4,6)
      cmat(6,5) = cmat(5,6)
      cmat(6,6) = 7.631609d+02
