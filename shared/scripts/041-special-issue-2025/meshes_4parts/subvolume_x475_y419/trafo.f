...
c     x            0.d0 , 0.d0 , 0.d0 , 0.d0, 0.d0 , 4.63d-1 /
      cmat(1,1) = 4.020263d+03
      cmat(1,2) = 1.520951d+03
      cmat(1,3) = 1.374313d+03
      cmat(1,4) = 9.332004d+01
      cmat(1,5) = 4.859800d+02
      cmat(1,6) = -3.575371d+02
      cmat(2,1) = cmat(1,2)
      cmat(2,2) = -5.306288d+03
      cmat(2,3) = -4.967842d+01
      cmat(2,4) = 1.326349d+03
      cmat(2,5) = 6.814023d+02
      cmat(2,6) = -4.194404d+03
      cmat(3,1) = cmat(1,3)
      cmat(3,2) = cmat(2,3)
      cmat(3,3) = 7.305958d+03
      cmat(3,4) = 3.814861d+01
      cmat(3,5) = 1.249337d+03
      cmat(3,6) = 8.180748d+02
      cmat(4,1) = 1.114734d+04
      cmat(4,2) = 1.326349d+03
      cmat(4,3) = cmat(3,4)
      cmat(4,4) = -4.403753d+02
      cmat(4,5) = -1.480239d+03
      cmat(4,6) = 5.840106d+02
      cmat(5,1) = cmat(1,5)
      cmat(5,2) = cmat(2,5)
      cmat(5,3) = cmat(3,5)
      cmat(5,4) = cmat(4,5)
      cmat(5,5) = 1.869064d+02
      cmat(5,6) = 6.780600d+02
      cmat(6,1) = cmat(1,6)
      cmat(6,2) = cmat(2,6)
      cmat(6,3) = cmat(3,6)
      cmat(6,4) = cmat(4,6)
      cmat(6,5) = cmat(5,6)
      cmat(6,6) = -1.158123d+03
