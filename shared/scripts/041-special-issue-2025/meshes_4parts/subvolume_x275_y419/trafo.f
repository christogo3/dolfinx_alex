...
c     x            0.d0 , 0.d0 , 0.d0 , 0.d0, 0.d0 , 4.63d-1 /
      cmat(1,1) = 3.195092d+03
      cmat(1,2) = 1.206373d+03
      cmat(1,3) = 1.033638d+03
      cmat(1,4) = 2.603861d+00
      cmat(1,5) = -9.151269d+01
      cmat(1,6) = -1.322871d+02
      cmat(2,1) = cmat(1,2)
      cmat(2,2) = -7.373680d+03
      cmat(2,3) = -1.740062d+03
      cmat(2,4) = -1.041397d+03
      cmat(2,5) = 8.290801d+02
      cmat(2,6) = 3.347037d+03
      cmat(3,1) = cmat(1,3)
      cmat(3,2) = cmat(2,3)
      cmat(3,3) = 2.177911d+03
      cmat(3,4) = -1.571638d+02
      cmat(3,5) = 8.246271d+02
      cmat(3,6) = 4.044511d+03
      cmat(4,1) = 2.549756d+03
      cmat(4,2) = -1.041397d+03
      cmat(4,3) = cmat(3,4)
      cmat(4,4) = -3.906214d+02
      cmat(4,5) = 6.917024d+02
      cmat(4,6) = 4.075192d+03
      cmat(5,1) = cmat(1,5)
      cmat(5,2) = cmat(2,5)
      cmat(5,3) = cmat(3,5)
      cmat(5,4) = cmat(4,5)
      cmat(5,5) = 1.559506d+03
      cmat(5,6) = 4.001597d+03
      cmat(6,1) = cmat(1,6)
      cmat(6,2) = cmat(2,6)
      cmat(6,3) = cmat(3,6)
      cmat(6,4) = cmat(4,6)
      cmat(6,5) = cmat(5,6)
      cmat(6,6) = 3.244590d+03
