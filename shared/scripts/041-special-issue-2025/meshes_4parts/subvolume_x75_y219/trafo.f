...
c     x            0.d0 , 0.d0 , 0.d0 , 0.d0, 0.d0 , 4.63d-1 /
      cmat(1,1) = 4.593411d+03
      cmat(1,2) = 2.140776d+03
      cmat(1,3) = 2.134334d+03
      cmat(1,4) = 1.517378d+01
      cmat(1,5) = 5.041645d+00
      cmat(1,6) = 4.360151d+01
      cmat(2,1) = cmat(1,2)
      cmat(2,2) = 2.818338d+03
      cmat(2,3) = 6.363461d+02
      cmat(2,4) = 4.412659d+01
      cmat(2,5) = -2.627371d+02
      cmat(2,6) = 4.768154d+02
      cmat(3,1) = cmat(1,3)
      cmat(3,2) = cmat(2,3)
      cmat(3,3) = 3.385864d+03
      cmat(3,4) = -5.833615d+01
      cmat(3,5) = -1.183846d+01
      cmat(3,6) = 2.950886d+02
      cmat(4,1) = -3.374372d+03
      cmat(4,2) = 4.412659d+01
      cmat(4,3) = cmat(3,4)
      cmat(4,4) = 1.178409d+03
      cmat(4,5) = -1.302967d+02
      cmat(4,6) = 3.704153d+02
      cmat(5,1) = cmat(1,5)
      cmat(5,2) = cmat(2,5)
      cmat(5,3) = cmat(3,5)
      cmat(5,4) = cmat(4,5)
      cmat(5,5) = 1.475706d+03
      cmat(5,6) = 2.592848d+02
      cmat(6,1) = cmat(1,6)
      cmat(6,2) = cmat(2,6)
      cmat(6,3) = cmat(3,6)
      cmat(6,4) = cmat(4,6)
      cmat(6,5) = cmat(5,6)
      cmat(6,6) = 1.916152d+03
