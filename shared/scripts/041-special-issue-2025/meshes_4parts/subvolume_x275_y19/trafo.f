...
c     x            0.d0 , 0.d0 , 0.d0 , 0.d0, 0.d0 , 4.63d-1 /
      cmat(1,1) = 5.474629d+03
      cmat(1,2) = 2.491927d+03
      cmat(1,3) = 2.497597d+03
      cmat(1,4) = -3.913522d+01
      cmat(1,5) = 2.715003d+01
      cmat(1,6) = 3.968702d+00
      cmat(2,1) = cmat(1,2)
      cmat(2,2) = 9.742822d+03
      cmat(2,3) = 4.297635d+03
      cmat(2,4) = -3.116327d+02
      cmat(2,5) = 1.519006d+02
      cmat(2,6) = -1.488739d+03
      cmat(3,1) = cmat(1,3)
      cmat(3,2) = cmat(2,3)
      cmat(3,3) = 5.073933d+03
      cmat(3,4) = 2.141018d+02
      cmat(3,5) = -2.510294d+02
      cmat(3,6) = 2.352837d+02
      cmat(4,1) = -3.871705d+02
      cmat(4,2) = -3.116327d+02
      cmat(4,3) = cmat(3,4)
      cmat(4,4) = 2.120768d+03
      cmat(4,5) = -9.429270d+02
      cmat(4,6) = 1.298713d+02
      cmat(5,1) = cmat(1,5)
      cmat(5,2) = cmat(2,5)
      cmat(5,3) = cmat(3,5)
      cmat(5,4) = cmat(4,5)
      cmat(5,5) = 1.514439d+03
      cmat(5,6) = 2.603605d+02
      cmat(6,1) = cmat(1,6)
      cmat(6,2) = cmat(2,6)
      cmat(6,3) = cmat(3,6)
      cmat(6,4) = cmat(4,6)
      cmat(6,5) = cmat(5,6)
      cmat(6,6) = 2.331195d+03
