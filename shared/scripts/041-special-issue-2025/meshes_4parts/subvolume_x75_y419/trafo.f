...
c     x            0.d0 , 0.d0 , 0.d0 , 0.d0, 0.d0 , 4.63d-1 /
      cmat(1,1) = 7.129187d+03
      cmat(1,2) = 2.792029d+03
      cmat(1,3) = 2.673776d+03
      cmat(1,4) = 3.246741d+01
      cmat(1,5) = 9.367209d+01
      cmat(1,6) = -1.931472d+01
      cmat(2,1) = cmat(1,2)
      cmat(2,2) = 4.100697d+03
      cmat(2,3) = 1.932292d+03
      cmat(2,4) = 4.436213d+02
      cmat(2,5) = -5.896327d+03
      cmat(2,6) = 3.918809d+03
      cmat(3,1) = cmat(1,3)
      cmat(3,2) = cmat(2,3)
      cmat(3,3) = 8.673436d+03
      cmat(3,4) = -6.930811d+02
      cmat(3,5) = -5.832615d+03
      cmat(3,6) = 3.857269d+03
      cmat(4,1) = 2.156927d+02
      cmat(4,2) = 4.436213d+02
      cmat(4,3) = cmat(3,4)
      cmat(4,4) = 1.820837d+03
      cmat(4,5) = -5.930134d+03
      cmat(4,6) = 3.911023d+03
      cmat(5,1) = cmat(1,5)
      cmat(5,2) = cmat(2,5)
      cmat(5,3) = cmat(3,5)
      cmat(5,4) = cmat(4,5)
      cmat(5,5) = -3.728411d+03
      cmat(5,6) = 3.273378d+03
      cmat(6,1) = cmat(1,6)
      cmat(6,2) = cmat(2,6)
      cmat(6,3) = cmat(3,6)
      cmat(6,4) = cmat(4,6)
      cmat(6,5) = cmat(5,6)
      cmat(6,6) = 5.170472d+03
