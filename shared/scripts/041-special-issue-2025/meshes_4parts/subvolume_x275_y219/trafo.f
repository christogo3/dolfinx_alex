...
c     x            0.d0 , 0.d0 , 0.d0 , 0.d0, 0.d0 , 4.63d-1 /
      cmat(1,1) = 3.391910d+03
      cmat(1,2) = 1.513507d+03
      cmat(1,3) = 1.570043d+03
      cmat(1,4) = 4.513895d+00
      cmat(1,5) = 3.355284d+00
      cmat(1,6) = -5.500352d+00
      cmat(2,1) = cmat(1,2)
      cmat(2,2) = -3.433406d+02
      cmat(2,3) = -3.665654d+02
      cmat(2,4) = -1.736278d+02
      cmat(2,5) = 1.192026d+02
      cmat(2,6) = 1.569684d+03
      cmat(3,1) = cmat(1,3)
      cmat(3,2) = cmat(2,3)
      cmat(3,3) = 2.947524d+03
      cmat(3,4) = -2.135369d+02
      cmat(3,5) = 2.784006d+02
      cmat(3,6) = 1.090551d+03
      cmat(4,1) = -1.587833d+03
      cmat(4,2) = -1.736278d+02
      cmat(4,3) = cmat(3,4)
      cmat(4,4) = 4.278776d+02
      cmat(4,5) = 4.131092d+02
      cmat(4,6) = 1.098235d+03
      cmat(5,1) = cmat(1,5)
      cmat(5,2) = cmat(2,5)
      cmat(5,3) = cmat(3,5)
      cmat(5,4) = cmat(4,5)
      cmat(5,5) = 1.372939d+03
      cmat(5,6) = 9.360243d+02
      cmat(6,1) = cmat(1,6)
      cmat(6,2) = cmat(2,6)
      cmat(6,3) = cmat(3,6)
      cmat(6,4) = cmat(4,6)
      cmat(6,5) = cmat(5,6)
      cmat(6,6) = 1.714762d+03
