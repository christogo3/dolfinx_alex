...
c     x            0.d0 , 0.d0 , 0.d0 , 0.d0, 0.d0 , 4.63d-1 /
      cmat(1,1) = 4.581552d+03
      cmat(1,2) = 1.969947d+03
      cmat(1,3) = 2.040145d+03
      cmat(1,4) = 6.747663d+00
      cmat(1,5) = 3.004985d+00
      cmat(1,6) = 4.753563d-01
      cmat(2,1) = cmat(1,2)
      cmat(2,2) = 3.047808d+03
      cmat(2,3) = 1.285866d+03
      cmat(2,4) = 2.594900d+01
      cmat(2,5) = 6.962421d+01
      cmat(2,6) = 3.748444d+02
      cmat(3,1) = cmat(1,3)
      cmat(3,2) = cmat(2,3)
      cmat(3,3) = 4.406111d+03
      cmat(3,4) = -1.336450d+02
      cmat(3,5) = 3.931198d+02
      cmat(3,6) = 2.317589d+02
      cmat(4,1) = -5.464443d+02
      cmat(4,2) = 2.594900d+01
      cmat(4,3) = cmat(3,4)
      cmat(4,4) = 1.094610d+03
      cmat(4,5) = 1.405658d+02
      cmat(4,6) = 4.043886d+02
      cmat(5,1) = cmat(1,5)
      cmat(5,2) = cmat(2,5)
      cmat(5,3) = cmat(3,5)
      cmat(5,4) = cmat(4,5)
      cmat(5,5) = 1.460076d+03
      cmat(5,6) = 1.430125d+02
      cmat(6,1) = cmat(1,6)
      cmat(6,2) = cmat(2,6)
      cmat(6,3) = cmat(3,6)
      cmat(6,4) = cmat(4,6)
      cmat(6,5) = cmat(5,6)
      cmat(6,6) = 1.311933d+03
