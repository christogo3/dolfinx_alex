...
c     x            0.d0 , 0.d0 , 0.d0 , 0.d0, 0.d0 , 4.63d-1 /
      cmat(1,1) = 1.833476d+03
      cmat(1,2) = 5.893490d+02
      cmat(1,3) = 6.760696d+02
      cmat(1,4) = -5.301090d+01
      cmat(1,5) = 5.215780d+01
      cmat(1,6) = -3.444380d+02
      cmat(2,1) = cmat(1,2)
      cmat(2,2) = 5.499266d+03
      cmat(2,3) = 1.272012d+02
      cmat(2,4) = -5.137036d+02
      cmat(2,5) = 5.798506d+02
      cmat(2,6) = 1.002621d+03
      cmat(3,1) = cmat(1,3)
      cmat(3,2) = cmat(2,3)
      cmat(3,3) = 4.023261d+02
      cmat(3,4) = -9.938470d+01
      cmat(3,5) = 8.590434d+02
      cmat(3,6) = -9.226736d+02
      cmat(4,1) = -4.032753d+03
      cmat(4,2) = -5.137036d+02
      cmat(4,3) = cmat(3,4)
      cmat(4,4) = 1.557752d+03
      cmat(4,5) = 1.951543d+03
      cmat(4,6) = -4.174980d+02
      cmat(5,1) = cmat(1,5)
      cmat(5,2) = cmat(2,5)
      cmat(5,3) = cmat(3,5)
      cmat(5,4) = cmat(4,5)
      cmat(5,5) = 1.242552d+03
      cmat(5,6) = -7.640621d+02
      cmat(6,1) = cmat(1,6)
      cmat(6,2) = cmat(2,6)
      cmat(6,3) = cmat(3,6)
      cmat(6,4) = cmat(4,6)
      cmat(6,5) = cmat(5,6)
      cmat(6,6) = 7.851193d+02
