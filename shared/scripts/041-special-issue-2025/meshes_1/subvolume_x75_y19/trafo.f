...
c     x            0.d0 , 0.d0 , 0.d0 , 0.d0, 0.d0 , 4.63d-1 /
      cmat(1,1) = 2.186554d+03
      cmat(1,2) = 9.420835d+02
      cmat(1,3) = 9.418139d+02
      cmat(1,4) = -8.102610d-03
      cmat(1,5) = -1.979915d+01
      cmat(1,6) = -6.943979d+00
      cmat(2,1) = cmat(1,2)
      cmat(2,2) = 2.085981d+03
      cmat(2,3) = 8.015187d+02
      cmat(2,4) = 7.560040d+01
      cmat(2,5) = -3.969252d+01
      cmat(2,6) = 1.503364d+02
      cmat(3,1) = cmat(1,3)
      cmat(3,2) = cmat(2,3)
      cmat(3,3) = 1.998141d+03
      cmat(3,4) = 5.148905d+01
      cmat(3,5) = 4.154162d+01
      cmat(3,6) = -1.457773d+02
      cmat(4,1) = -5.761443d+02
      cmat(4,2) = 7.560040d+01
      cmat(4,3) = cmat(3,4)
      cmat(4,4) = 6.321824d+02
      cmat(4,5) = 1.191231d+02
      cmat(4,6) = -1.080128d+02
      cmat(5,1) = cmat(1,5)
      cmat(5,2) = cmat(2,5)
      cmat(5,3) = cmat(3,5)
      cmat(5,4) = cmat(4,5)
      cmat(5,5) = 6.811869d+02
      cmat(5,6) = -1.266640d+02
      cmat(6,1) = cmat(1,6)
      cmat(6,2) = cmat(2,6)
      cmat(6,3) = cmat(3,6)
      cmat(6,4) = cmat(4,6)
      cmat(6,5) = cmat(5,6)
      cmat(6,6) = 5.480461d+02
