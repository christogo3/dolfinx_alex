...
c     x            0.d0 , 0.d0 , 0.d0 , 0.d0, 0.d0 , 4.63d-1 /
      cmat(1,1) = 1.960276d+03
      cmat(1,2) = 7.760909d+02
      cmat(1,3) = 7.928033d+02
      cmat(1,4) = 8.018238d+00
      cmat(1,5) = 9.293024d+00
      cmat(1,6) = -1.085228d+01
      cmat(2,1) = cmat(1,2)
      cmat(2,2) = 9.408809d+02
      cmat(2,3) = 3.631511d+02
      cmat(2,4) = 5.373969d+01
      cmat(2,5) = -1.113762d+02
      cmat(2,6) = 2.053213d+02
      cmat(3,1) = cmat(1,3)
      cmat(3,2) = cmat(2,3)
      cmat(3,3) = 1.787077d+03
      cmat(3,4) = -3.519559d+00
      cmat(3,5) = 1.459123d+02
      cmat(3,6) = 8.116077d+01
      cmat(4,1) = 1.063171d+02
      cmat(4,2) = 5.373969d+01
      cmat(4,3) = cmat(3,4)
      cmat(4,4) = 3.695218d+02
      cmat(4,5) = -4.343019d+01
      cmat(4,6) = 1.841360d+02
      cmat(5,1) = cmat(1,5)
      cmat(5,2) = cmat(2,5)
      cmat(5,3) = cmat(3,5)
      cmat(5,4) = cmat(4,5)
      cmat(5,5) = 4.917511d+02
      cmat(5,6) = 7.013020d+01
      cmat(6,1) = cmat(1,6)
      cmat(6,2) = cmat(2,6)
      cmat(6,3) = cmat(3,6)
      cmat(6,4) = cmat(4,6)
      cmat(6,5) = cmat(5,6)
      cmat(6,6) = 4.347040d+02
