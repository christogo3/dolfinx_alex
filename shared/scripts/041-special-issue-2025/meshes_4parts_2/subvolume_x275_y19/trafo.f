...
c     x            0.d0 , 0.d0 , 0.d0 , 0.d0, 0.d0 , 4.63d-1 /
      cmat(1,1) = 3.631766d+03
      cmat(1,2) = 1.524749d+03
      cmat(1,3) = 1.525184d+03
      cmat(1,4) = -5.580168d+01
      cmat(1,5) = 5.508163d+01
      cmat(1,6) = 5.491746d+01
      cmat(2,1) = cmat(1,2)
      cmat(2,2) = 9.753016d+03
      cmat(2,3) = 3.693360d+03
      cmat(2,4) = 2.370218d+02
      cmat(2,5) = 1.300545d+02
      cmat(2,6) = -1.394637d+03
      cmat(3,1) = cmat(1,3)
      cmat(3,2) = cmat(2,3)
      cmat(3,3) = 3.648983d+03
      cmat(3,4) = 1.136500d+02
      cmat(3,5) = -1.053984d+02
      cmat(3,6) = 2.705072d+02
      cmat(4,1) = -6.745148d+01
      cmat(4,2) = 2.370218d+02
      cmat(4,3) = cmat(3,4)
      cmat(4,4) = 1.984749d+03
      cmat(4,5) = -7.536004d+02
      cmat(4,6) = 8.090763d+01
      cmat(5,1) = cmat(1,5)
      cmat(5,2) = cmat(2,5)
      cmat(5,3) = cmat(3,5)
      cmat(5,4) = cmat(4,5)
      cmat(5,5) = 1.177228d+03
      cmat(5,6) = 2.457793d+02
      cmat(6,1) = cmat(1,6)
      cmat(6,2) = cmat(2,6)
      cmat(6,3) = cmat(3,6)
      cmat(6,4) = cmat(4,6)
      cmat(6,5) = cmat(5,6)
      cmat(6,6) = 2.139137d+03
