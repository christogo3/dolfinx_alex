...
c     x            0.d0 , 0.d0 , 0.d0 , 0.d0, 0.d0 , 4.63d-1 /
      cmat(1,1) = 1.749748d+03
      cmat(1,2) = 7.554341d+02
      cmat(1,3) = 6.662940d+02
      cmat(1,4) = -4.949116d+00
      cmat(1,5) = 3.287939d+01
      cmat(1,6) = 1.240489d+00
      cmat(2,1) = cmat(1,2)
      cmat(2,2) = 3.846846d+03
      cmat(2,3) = 1.441871d+03
      cmat(2,4) = 8.862383d+02
      cmat(2,5) = -6.116483d+02
      cmat(2,6) = -4.848488d+02
      cmat(3,1) = cmat(1,3)
      cmat(3,2) = cmat(2,3)
      cmat(3,3) = 2.402142d+03
      cmat(3,4) = 3.355746d+01
      cmat(3,5) = -6.100714d+02
      cmat(3,6) = -4.504674d+02
      cmat(4,1) = 5.033002d+02
      cmat(4,2) = 8.862383d+02
      cmat(4,3) = cmat(3,4)
      cmat(4,4) = 8.075875d+02
      cmat(4,5) = -6.255850d+02
      cmat(4,6) = -4.496475d+02
      cmat(5,1) = cmat(1,5)
      cmat(5,2) = cmat(2,5)
      cmat(5,3) = cmat(3,5)
      cmat(5,4) = cmat(4,5)
      cmat(5,5) = -1.489661d+02
      cmat(5,6) = -3.857115d+02
      cmat(6,1) = cmat(1,6)
      cmat(6,2) = cmat(2,6)
      cmat(6,3) = cmat(3,6)
      cmat(6,4) = cmat(4,6)
      cmat(6,5) = cmat(5,6)
      cmat(6,6) = 2.253273d+02
