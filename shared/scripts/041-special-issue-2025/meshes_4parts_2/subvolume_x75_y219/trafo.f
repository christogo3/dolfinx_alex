...
c     x            0.d0 , 0.d0 , 0.d0 , 0.d0, 0.d0 , 4.63d-1 /
      cmat(1,1) = 2.110657d+03
      cmat(1,2) = 9.380875d+02
      cmat(1,3) = 9.338343d+02
      cmat(1,4) = 2.766466d+00
      cmat(1,5) = -7.579942d+00
      cmat(1,6) = 3.210502d+01
      cmat(2,1) = cmat(1,2)
      cmat(2,2) = 7.490787d+02
      cmat(2,3) = -2.622051d+02
      cmat(2,4) = 5.484842d+01
      cmat(2,5) = -8.910731d+01
      cmat(2,6) = -1.838856d+02
      cmat(3,1) = cmat(1,3)
      cmat(3,2) = cmat(2,3)
      cmat(3,3) = 1.172079d+03
      cmat(3,4) = 1.597186d+02
      cmat(3,5) = 2.177166d+02
      cmat(3,6) = -5.062794d+02
      cmat(4,1) = -3.068209d+03
      cmat(4,2) = 5.484842d+01
      cmat(4,3) = cmat(3,4)
      cmat(4,4) = 6.171825d+02
      cmat(4,5) = 6.657601d+01
      cmat(4,6) = -3.415568d+02
      cmat(5,1) = cmat(1,5)
      cmat(5,2) = cmat(2,5)
      cmat(5,3) = cmat(3,5)
      cmat(5,4) = cmat(4,5)
      cmat(5,5) = 1.061148d+03
      cmat(5,6) = -4.714993d+02
      cmat(6,1) = cmat(1,6)
      cmat(6,2) = cmat(2,6)
      cmat(6,3) = cmat(3,6)
      cmat(6,4) = cmat(4,6)
      cmat(6,5) = cmat(5,6)
      cmat(6,6) = 6.435814d+02
