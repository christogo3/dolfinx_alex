...
c     x            0.d0 , 0.d0 , 0.d0 , 0.d0, 0.d0 , 4.63d-1 /
      cmat(1,1) = 1.855464d+03
      cmat(1,2) = 7.656064d+02
      cmat(1,3) = 7.822194d+02
      cmat(1,4) = -2.343226d+00
      cmat(1,5) = 7.027577d+00
      cmat(1,6) = -3.533034d+01
      cmat(2,1) = cmat(1,2)
      cmat(2,2) = -2.959504d+02
      cmat(2,3) = -9.585093d+01
      cmat(2,4) = 1.958946d+02
      cmat(2,5) = 4.754707d+01
      cmat(2,6) = -8.789509d+02
      cmat(3,1) = cmat(1,3)
      cmat(3,2) = cmat(2,3)
      cmat(3,3) = 1.784794d+03
      cmat(3,4) = -8.182048d+01
      cmat(3,5) = -2.074187d+02
      cmat(3,6) = -8.818148d+01
      cmat(4,1) = -2.660829d+02
      cmat(4,2) = 1.958946d+02
      cmat(4,3) = cmat(3,4)
      cmat(4,4) = 3.110720d+02
      cmat(4,5) = -3.841769d+02
      cmat(4,6) = -1.949837d+02
      cmat(5,1) = cmat(1,5)
      cmat(5,2) = cmat(2,5)
      cmat(5,3) = cmat(3,5)
      cmat(5,4) = cmat(4,5)
      cmat(5,5) = 6.344598d+02
      cmat(5,6) = -1.098559d+02
      cmat(6,1) = cmat(1,6)
      cmat(6,2) = cmat(2,6)
      cmat(6,3) = cmat(3,6)
      cmat(6,4) = cmat(4,6)
      cmat(6,5) = cmat(5,6)
      cmat(6,6) = 3.088273d+02
